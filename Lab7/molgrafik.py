...
class Ruta: # atom = name, num = weight
...
class Molgrafik:
    ...
    def show(self,p, weight):
        ...
        Label(self.root,text="Vikt: " + str(weight),font=self.stor,bg="white").pack(side=LEFT,fill=Y)
...
# obj = Molgrafik()
# r = Ruta(atom = "He", num=22)
# r.next = Ruta(atom = "Ba", num=32)
# r.down = Ruta(atom = "Fo", num=3.14)
# obj.show(r)
# obj.root.update()
